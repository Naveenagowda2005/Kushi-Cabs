-- ============================================================
-- FIX: Update accept_trip to allow accepting own assigned trip
-- Migration: 075_fix_accept_trip_active_trip_check.sql
-- Issue: Driver was blocked from accepting vendor-assigned trip if they had a previous stale current_trip_id
-- Solution: Allow driver to accept if current_trip_id is the same trip being accepted
-- ============================================================
...
-- ============================================================
-- Apply fix to reset stale current_trip_id for drivers
-- ============================================================
-- For drivers who have current_trip_id but no active trips, reset to NULL
DO $$
DECLARE
  r RECORD;
BEGIN
...
SELECT 'Migration 075 applied successfully - accept_trip updated to handle assigned trips' as status;
