-- Migration 107: Auto-approve driver verification when all documents are approved
-- When all 9 required documents are approved, automatically set overall_status to 'approved'
...
-- For existing drivers with all documents approved, update them manually
...
RAISE NOTICE '✅ Migration 107 complete: Auto-approval trigger created and existing drivers updated';
