...
-- This fixes the "Trip already accepted or unavailable" error
-- when drivers try to accept vendor-assigned trips
-- ============================================================
...
-- Test the fix
SELECT 'Migration 074 applied successfully - accept_trip function updated';
